...
This creates:
- `dist/vantage-firefox-v1.0.0.zip` — Ready for upload to the [Firefox Add-on Developer Hub](https://addons.mozilla.org/developers/).
- `dist/vantage-chrome-v1.0.0.zip` — Ready for upload to the [Chrome Web Store Developer Dashboard](https://chrome.google.com/webstore/devconsole).
