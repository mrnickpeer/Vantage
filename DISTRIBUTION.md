...
| :--- | :--- | :--- | :--- |
| **Firefox Add-ons (AMO)** | `dist/vantage-firefox-v1.1.1.zip` | ZIP archive | Manifest V3 with `background.scripts` & Gecko ID |
| **Chrome Web Store (CWS)** | `dist/vantage-chrome-v1.1.1.zip` | ZIP archive | Manifest V3 with `background.service_worker` |
| **Microsoft Edge Add-ons** | `dist/vantage-chrome-v1.1.1.zip` | ZIP archive | Same Chromium Manifest V3 bundle as CWS |
...
3. Drag and drop:
   `dist/vantage-chrome-v1.1.1.zip`
...
3. When prompted to upload the extension package, upload:
   `dist/vantage-chrome-v1.1.1.zip` (for Vantage) or `dist/visage-chrome-v1.0.1.zip` (for Visage).
